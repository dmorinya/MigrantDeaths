...
params <- c("w_b0", "q_b0", "q_b1", "delta_b0", "phi1", "phi2", "phi3", "sigma2_w", "component_chosen")
clusterExport(cl, list("data_CMR", "params"))
system.time(cmed_route <- jags.parallel(data = data_CMR, inits = NULL, parameters.to.save = params, model.file = ar3_model, n.chains = 5, n.iter = 50000, n.burnin = 10000, n.thin = 1000, DIC = T, jags.module = "mix"))
stopCluster(cl)
save(list="cmed_route", file="Results/cmed_route_covsAR3_2.RData")