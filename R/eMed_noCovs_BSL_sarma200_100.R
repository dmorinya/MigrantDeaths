...
est_distr <- "../Results/estad_distr_EMR_sarma200_100.pdf"
...
### Export the results
name_data <- "../Results/EMR_incidence_sarma200_100.csv"
...
save(list=ls(), file="../Results/eMed_results_sarma200_100.RData")
