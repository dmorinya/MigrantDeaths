...
est_distr <- "../Results/estad_distr_WMR_sarma101_100.pdf"
...
### Export the results
name_data <- "../Results/WMR_incidence_sarma101_100.csv"
...
save(list=ls(), file="../Results/wMed_results_sarma101_100.RData")
