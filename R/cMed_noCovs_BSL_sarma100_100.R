...
est_distr <- "../Results/estad_distr_CMR_sarma100_100.pdf"
...
### Export the results
name_data <- "../Results/CMR_incidence_sarma100_100.csv"
...
save(list=ls(), file="../Results/cMed_results_sarma100_100.RData")
