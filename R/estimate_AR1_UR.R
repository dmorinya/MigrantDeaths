...
system.time(cmed_route <- jags.parallel(data = data_CMR, inits = NULL, parameters.to.save = params, model.file = ar1_model, n.chains = 5, n.iter = 5000, n.burnin = 500, n.thin = 10, DIC = T, jags.module = "mix"))
stopCluster(cl)
save(list="cmed_route", file="Results/cmed_route_covsAR1.RData")
...
system.time(wmed_route <- jags.parallel(data = data_WMR, inits = NULL, parameters.to.save = params, model.file = ar1_model,
                                        n.chains = 5, n.iter = 5000, n.burnin = 500, n.thin = 10, DIC = T, jags.module = "mix"))
stopCluster(cl)
save(list="wmed_route", file="Results/wmed_route_covsAR1.RData")
...
system.time(emed_route <- jags.parallel(data = data_EMR, inits = NULL, parameters.to.save = params, model.file = ar1_model,
                                        n.chains = 5, n.iter = 5000, n.burnin = 500, n.thin = 10, DIC = T, jags.module = "mix"))
stopCluster(cl)
save(list="emed_route", file="Results/emed_route_covsAR1.RData")
