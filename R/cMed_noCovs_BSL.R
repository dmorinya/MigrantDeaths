...
est_distr <- "../Results/estad_distr_CMR.pdf"
...
posterior_probs <- lapply(resultMigrant@theta[, 7], FUN=function(x){EM(dCMRsmo, 2, 1e-16, x)})
...
### Export the results
name_data <- "../Results/CMR_incidence.csv"
...
save(list=ls(), file="../Results/cMed_results.RData")
