...
est_distr <- "../Results/estad_distr_WMR_sarma200_100.pdf"
...
posterior_probs <- lapply(resultMigrant@theta[, 9], FUN=function(x){EM(dWMRsmo, 2, 1e-16, x)})
...
### Export the results
name_data <- "../Results/WMR_incidence_sarma200_100.csv"
...
save(list=ls(), file="../Results/wMed_results_sarma200_100.RData")
