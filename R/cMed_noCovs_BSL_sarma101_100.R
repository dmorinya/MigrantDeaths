...
est_distr <- "../Results/estad_distr_CMR_sarma101_100.pdf"
...
### Export the results
name_data <- "../Results/CMR_incidence_sarma101_100.csv"
...
save(list=ls(), file="../Results/cMed_results_sarma101_100.RData")
